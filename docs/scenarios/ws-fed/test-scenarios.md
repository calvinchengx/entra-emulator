...
> Archived copy at finalize (15 Aug 2026) from `docs/feature/ws-fed/distill/test-scenarios.md`.  
> Architecture SSOT: `docs/product/architecture/`. Journeys: `docs/product/journeys/`. Gherkin: `tests/acceptance/ws-fed/`.  
> DISTILL-time status rows (`@pending`, `t.Skip`, RED) are historical. All 12 DELIVER steps completed.  
> KPI source after cleanup: `docs/evolution/2026-08-14-ws-fed.md` (originally `docs/feature/ws-fed/discuss/outcome-kpis.md`). Stories: originally `docs/feature/ws-fed/discuss/user-stories.md`.
